...
#'
#' @param x see \code{\link[latticeExtra]{segplot}}.
#' 
#' @param y see \code{\link[latticeExtra]{segplot}}.
#' 
#' @param centers see \code{\link[latticeExtra]{segplot}}.
#' 
#' @param subscripts see \code{\link[latticeExtra]{segplot}}.
#' 
