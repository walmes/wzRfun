...
#' @description The tropical soils, usually poor in potassium (K),
#'     demand potassium fertilization when cultivated with soybean
#'     (\emph{Glycine max} L.)  to obtain satisfactory yields. The aim
...
#'     arrangement. The K doses (\code{potassium}) were 0; 30; 60, 120
#'     and 180 mg dm\eqn{^{-3}} , and the soil humidity (\code{water})
